...
```{r Select and Recode}
DF$semdat = DF$orgdat %>%
  select(ends_with(c(paste0(DF$setup$x),paste0(DF$setup$y),paste0(DF$setup$grp))) &
           starts_with(c(paste0(DF$setup$wave1),paste0(DF$setup$wave2),paste0(DF$setup$wave3),paste0(DF$setup$wave4))))
...
```{r Estimate Mod1}
tic()
DF$lv_fit$cl$mc <- lavaan(DF$modef$cl$m4c,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_fit$cl$mu <- lavaan(DF$modef$cl$m4u,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_fit$ri$mc <- lavaan(DF$modef$ri$m4c,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_fit$ri$mu <- lavaan(DF$modef$ri$m4u,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_fit$ri$mcn <- lavaan(DF$modef$ri$m4c,  data=DF$semdatn, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_fit$ri$mun <- lavaan(DF$modef$ri$m4u,  data=DF$semdatn, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
# DF$lv_fit$ri$mcg <- lavaan(DF$modef$ri$m4c,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T, group = "pol_int")
DF$lv_fit$ri$mug <- lavaan(DF$modef$ri$m4u,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T, group = "pol_int")
toc()
```
