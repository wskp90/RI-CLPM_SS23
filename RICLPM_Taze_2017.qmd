...
## Select Vars
```{r}
DF$semdat = DF$orgdat %>% select(ends_with(c("_taze","theta_pwk")) & starts_with(c("kp4","kp5","kp7")))
# head(DF$semdat)
# head(DF$semdat_long)
DF$semdat %<>% rename(x1 = kp4_taze, x2 = kp5_taze, x3 = kp7_taze,
                      y1 = kp4_theta_pwk, y2 = kp5_theta_pwk, y3 = kp7_theta_pwk)
