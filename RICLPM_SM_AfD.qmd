...
subtitle: "Social Media-Nutzung vs AfD Sympathie"
author:
- "Reimar ZEH"
...
## Select Vars
```{r}
DF$semdat = DF$orgdat %>% select(contains(c("_1610","_430i")) & starts_with(c("kp17","kp18","kp19")))
# head(DF$semdat)
DF$semdat_long = DF$semdat %>% pivot_longer(cols = everything(), names_to = c("set",".value"), names_sep = "_")
# head(DF$semdat_long)
names(DF$semdat_long) = c("Welle","x","m")
DF$semdat %<>% rename(x1 = kp17_1610, x2 = kp18_1610, x3 = kp19_1610,
