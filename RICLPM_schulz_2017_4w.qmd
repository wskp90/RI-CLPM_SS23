...
DF$semdat %<>% mutate(kp4_wwtv = rowSums(across(contains("kp4_421d")),na.rm = F),
                     kp4_wwtv = as.numeric(kp4_wwtv >0),
                     kp4_wwra = rowSums(across(contains("kp4_421e")),na.rm = F),
                     kp4_wwra = as.numeric(kp4_wwra > 0),
                     kp4_wwfl = rowSums(across(contains("kp4_421b")),na.rm = F),
                     kp4_wwfl = as.numeric(kp4_wwfl > 0),
                     kp4_wwpl = rowSums(across(contains("kp4_421g")),na.rm = F),
                     kp4_wwpl = as.numeric(kp4_wwpl > 0),
                     kp5_wwtv = rowSums(across(contains("kp5_421d")),na.rm = F),
                     ...
                     kp4_waw = rowSums(across(contains("kp4_ww")),na.rm =F),
