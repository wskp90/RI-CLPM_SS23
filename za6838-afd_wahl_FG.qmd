...
DF$afd_dat = DF$orgdat %>% select(ends_with("_430i"))
...
DF$afd_dat %<>% mutate(across(ends_with("_430i"), ~rec(., rec = "-99,-97,-95,-93,-92,-71=NA; else = copy"))) # %>%   column_to_rownames(var = "lfdn")
...
DF$aufstock %<>% mutate(across(everything(), ~rec(., rec = "-99,-97,-95,-93,-71=NA;else = copy")))
...
DF$semdat %>% select("kp17_010","kp16_trust", "kp17_popul", "kp17_extrem", "kp17_ineff", "kp17_exeff","kp16_consp","kp17_430i","kp17_020","kp16_1500") %>% psych::cor.plot(.,stars = T)
