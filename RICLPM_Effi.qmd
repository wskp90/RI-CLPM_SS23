...
subtitle: "Political Efficacy - Fully Contrained Models"
author:
- "Reimar ZEH"
...
## Select Vars
```{r}
DF$semdat_1 = DF$orgdat %>% select(contains(c("_020","_050a","_050e","_050h","_050k")) & starts_with(c("kp14","kp15","kp16","kp17","kp18")) & !ends_with("be"))
head(DF$semdat_1)
