...
subtitle: "Gespräche vs AfD Sympathie"
author:
- "Reimar ZEH"
...
## Select Vars
```{r}
DF$semdat = DF$orgdat %>% select(contains(c("_1933","_430i")) & starts_with(c("kp17","kp18","kp19")) & !ends_with("flag"))
head(DF$semdat)
DF$semdat_long = DF$semdat %>% pivot_longer(cols = everything(), names_to = c("set",".value"), names_sep = "_")
# head(DF$semdat_long)
names(DF$semdat_long) = c("Welle","x","m")
DF$semdat %<>% rename(x1 = kp17_1933, x2 = kp18_1933, x3 = kp19_1933,
