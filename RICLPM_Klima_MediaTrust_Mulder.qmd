...
#                       y1 = kp10_160p, y2 = kp12_160p, y3 = kp14_160p, y4 = kp15_160p, y5 = kp16_160p)
DF$semdat %<>% rename(x1 = kp10_1290, x2 = kp12_1290, x3 = kp14_1290, x4 = kp15_1290, x5 = kp16_1290,
                      y1 = kp10_160p, y2 = kp12_160p, y3 = kp14_160p, y4 = kp15_160p, y5 = kp16_160p)
...
# DF$semdat %>% select(ends_with(c("_1290","_160p"))) %>% 
...
## Compare Model Fit
```{r Model fit}
CL_Modell = c("CLPM 5 fixed","CLPM 5 free","CLPM 4 fixed","CLPM 4 free", "CLPM 3 fixed","CLPM 3 free")
RI_Modell = c("RI-CLPM 5 fixed","RI-CLPM 5 free","RI-CLPM 5 C-ov","RI-CLPM 5 C-ri","RI-CLPM 4 fixed","RI-CLPM 4 free","RI-CLPM 3 fixed","RI-CLPM 3 free")
