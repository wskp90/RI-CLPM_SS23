...
```{r Select and Recode}
DF$semdat = DF$orgdat %>%
  select(ends_with(c("_160p","_430i")) & starts_with(c("kp9","kp10","kp12","kp14","kp15","kp16")))
head(DF$semdat)
```
...
```{r}
tic()
DF$lv_mod$cl$m6c <- lavaan::sem(DF$clpm_L6C, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$cl$m6a <- lavaan::sem(DF$clpm_L6A, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$cl$m6u <- lavaan::sem(DF$clpm_L6,  data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m6c <- lavaan::sem(DF$riclpm6C, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m6a <- lavaan::sem(DF$riclpm6A, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m6u <- lavaan::sem(DF$riclpm6,  data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)

DF$lv_mod$cl$m5c <- lavaan::sem(DF$clpm_L5C, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$cl$m5u <- lavaan::sem(DF$clpm_L5,  data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m5c <- lavaan::sem(DF$riclpm5C, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m5u <- lavaan::sem(DF$riclpm5,  data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)

DF$lv_mod$cl$m4c <- lavaan::sem(DF$clpm_L4C, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$cl$m4u <- lavaan::sem(DF$clpm_L4,  data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m4c <- lavaan::sem(DF$riclpm4C, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m4u <- lavaan::sem(DF$riclpm4,  data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)

DF$lv_mod$cl$m3c <- lavaan::sem(DF$clpm_L3C, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$cl$m3u <- lavaan::sem(DF$clpm_L3,  data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m3c <- lavaan::sem(DF$riclpm3C, data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
DF$lv_mod$ri$m3u <- lavaan::sem(DF$riclpm3,  data=DF$semdat, missing="ML", estimator = "MLR", mimic="Mplus", meanstructure = T)
toc()
```

## Compare Model Fit
```{r}
CL_Modell = c("CLPM 6 fixed","CLPM 6 AR fixed","CLPM 6 free","CLPM 5 fixed","CLPM 5 free","CLPM 4 fixed","CLPM 4 free", "CLPM 3 fixed","CLPM 3 free")
RI_Modell = c("RI-CLPM 6 fixed","RI-CLPM 6 AR fixed","RI-CLPM 6 free","RI-CLPM 5 fixed","RI-CLPM 5 free","RI-CLPM 4 fixed","RI-CLPM 4 free","RI-CLPM 3 fixed","RI-CLPM 3 free")
...
```
### CLPM 6 Wellen AR fixed
```{r}
plot(cl_graph_list$m6a)
```
### CLPM 6 Wellen fixed
```{r}
...
```
### RI-CLPM 6 Wellen AR fixed
```{r}
plot(ri_graph_list$m6a)
```
### RI-CLPM 6 Wellen fixed
```{r}
