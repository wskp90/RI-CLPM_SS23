...
pacman::p_load(foreign,tidyverse,sjmisc,sjlabelled,sjPlot,Hmisc,gt,gtExtras,gtsummary,panelr,
...
DF$semdat = DF$orgdat %>%
  select("lfdn", "kp1_2601", "kpa2_2601","kp1_2320", "kpx_2280","kpa1_2320", "kpx_2290s",
         contains("_1621"),
         all_of(DF$allscales),
         starts_with(c("kp7_","kp8_")) & contains(c("_1616","_1681")),
         starts_with(c("kp7_","kp8_")) & ends_with(c("_010","_160p","_1500","_020","_1600","_1610","_1701aa","_1702","_1933")))
