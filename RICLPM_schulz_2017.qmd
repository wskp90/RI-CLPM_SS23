...
## Select Vars
```{r}
DF$semdat = DF$orgdat %>% select(starts_with(c("n_participation","kp5_421","kp6_421","kp7_421","kp5_170","kp6_170","kp7_170","kpx_2290s")) &
...
DF$semdat %<>% mutate(alter = rec(kpx_2290s, rec ="1955 und frueher = 1955;else = copy"),
                      ...
                      alter = 2017- alter)
DF$semdat %<>% mutate(age_grp = dicho(alter, dich.by = 29))
```
