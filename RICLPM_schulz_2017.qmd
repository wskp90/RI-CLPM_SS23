...
## Select Vars
```{r}
DF$semdat = DF$orgdat %>% select(contains(c("_421","_170")) & !contains(c("_1701","_1702")) & !ends_with("flag") & !ends_with("y") & starts_with(c("kp5","kp6","kp7")))
# head(DF$semdat)
...
DF$semdat %<>% mutate(kp5_wwtv = rowSums(across(contains("kp5_421d")),na.rm = F),
                      ...
                      kp5_wwww = rowSums(across(contains("kp5_421k")),na.rm = F),
                      kp5_wwww = as.numeric(kp5_wwww > 0),
                      ...
                      kp6_wwww = rowSums(across(contains("kp6_421k")),na.rm = F),
                      kp6_wwww = as.numeric(kp6_wwww > 0),
                      ...
                      kp7_wwww = rowSums(across(contains("kp7_421k")),na.rm = F),
                      kp7_wwww = as.numeric(kp7_wwww > 0),
