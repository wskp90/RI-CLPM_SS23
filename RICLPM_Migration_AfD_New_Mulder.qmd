...
subtitle: "Migration vs AfD Sympathie"
author:
- "Reimar ZEH"
...
source(here("script/models_mulder.R"))
# toc()
```
...
```{r Select and Recode}
DF$semdat = DF$orgdat %>%
  select(ends_with(c("_1290","_430i","_1500")) & starts_with(c("kp10","kp12","kp14","kp15","kp16","kp17")))
head(DF$semdat)
```
...
# DF$semdat %<>% rename(x1 = kp10_1290, x2 = kp12_1290, x3 = kp14_1290, x4 = kp15_1290, x5 = kp16_1290,
#                       y1 = kp10_430i, y2 = kp12_430i, y3 = kp14_430i, y4 = kp15_430i, y5 = kp16_430i)
DF$semdat %<>% rename(x1 = kp10_1290, x2 = kp12_1290, x3 = kp14_1290, x4 = kp15_1290, x5 = kp16_1290, x6 = kp17_1290,
                      y1 = kp10_430i, y2 = kp12_430i, y3 = kp14_430i, y4 = kp15_430i, y5 = kp16_430i, y6 = kp17_430i)
...
# DF$semdat %>% select(ends_with(c("_1290","_430i"))) %>% 
...
```{r Estimate Models}
tic()
DF$lv_mod$cl$m6c <- lavaan(DF$clpm_L6C, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$cl$m6u <- lavaan(DF$clpm_L6,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m6c <- lavaan::sem(DF$riclpm6C, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m6u <- lavaan(DF$riclpm6,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m6cv <- lavaan(DF$riclpm6CV, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m6rcv <- lavaan(DF$riclpmR6RCV, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)

DF$lv_mod$cl$m5c <- lavaan(DF$clpm_L5C, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$cl$m5u <- lavaan(DF$clpm_L5,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m5c <- lavaan(DF$riclpm5C, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m5u <- lavaan(DF$riclpm5,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m5cv <- lavaan(DF$riclpm5CV, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m5rcv <- lavaan(DF$riclpm5RCV, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)


DF$lv_mod$cl$m4c <- lavaan(DF$clpm_L4C, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$cl$m4u <- lavaan(DF$clpm_L4,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m4c <- lavaan(DF$riclpm4C, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m4u <- lavaan(DF$riclpm4,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)

DF$lv_mod$cl$m3c <- lavaan(DF$clpm_L3C, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$cl$m3u <- lavaan(DF$clpm_L3,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m3c <- lavaan(DF$riclpm3C, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
DF$lv_mod$ri$m3u <- lavaan(DF$riclpm3,  data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
toc()
# DF$lv_mod$ri$m5cv <- lavaan(DF$riclpm5CV, data=DF$semdat, missing="ML", estimator = "MLR", meanstructure = T, int.ov.free = T)
