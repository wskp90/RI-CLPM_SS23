...
DF$semdat = DF$orgdat %>%
  select("lfdn", "kp1_2601", "kpa2_2601","kp1_2320", "kp9_2320", "kpa2_2320",
...
DF$afd_pred = c("wost","school","kp17_010","kp16_trust", "kp16_160p","kp17_popul", "kp17_extrem", "kp17_ineff", "kp17_exeff","kp16_consp","kp17_020","kp16_1500")
...
ggplot(DF$afd_cor, aes(y = reorder(variable, -KorKof), x = KorKof)) +
  ...
  labs(title = "Korrelation mit AfD-Sympathie",
       y = "Variables", x = "Correlation") +
...
fe_model <- plm::plm(trust ~ democrazy, DF$semdat_panel, index = c("id", "welle"), model = "within")
re_model <- plm::plm(trust ~ democrazy, DF$semdat_panel, index = c("id", "welle"), model = "random")
