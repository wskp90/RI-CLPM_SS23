...
DF$za6838.sel %<>% mutate(kp4_taze = rowSums(across(kp4_1616a:kp4_1616c),na.rm = F),
...
## Vars erstellen
```{r}
DF$za6838.sel %<>% mutate(across(kp2_3430q,kp3_3430v,kp4_3430q,kp5_3430v,kp6_3430q,kp7_3430v), ~rec(., rec = "322=1;-99,-95,-93,-92=NA;else=0")) #AFD
DF$za6838.sel %<>% mutate(across(kp2_3430c,kp4_3430c,kp6_3430c), ~rec(., rec = '3=1;-99,-95,-93,-92=NA;else=0')) # CSU
DF$za6838.sel %<>% mutate(across(kp2_3430l,kp4_3430l,kp6_3430l,kp3_3430s,kp5_3430s,kp7_3430s), ~rec(., rec = '6=1;-99,-95,-93,-92=NA;else=0')) #GRüNE 
DF$za6838.sel %<>% mutate(across(kp2_3430r,kp4_3430r,kp6_3430r,kp3_3430j,kp5_3430j,kp7_3430j), ~rec(., rec = '4=1;-99,-95,-93,-92=NA;else=0')) #SPD 
DF$za6838.sel %<>% mutate(across(kp2_3430p,kp4_3430p,kp6_3430p), ~rec(., rec = '5=1;-99,-95,-93,-92=NA;else=0')) #FDP 
DF$za6838.sel %<>% mutate(across(kp3_3430t,kp5_3430t,kp7_3430t,kp3_3430a,kp5_3430a,kp7_3430a), ~rec(., rec = '2=1;-99,-95,-93,-92=NA;else=0')) #CDU 
DF$za6838.sel %<>% mutate(across(kp2_3430m,kp4_3430m,kp6_3430m,kp3_3430u,kp5_3430u,kp7_3430u),~rec(., rec = '7=1;-99,-95,-93,-92=NA;else=0')) #LINKE 
```
### Welle 2
```{r}
...
cat('Cronbachs alpha(KR-20):')
ZA6838.data %>% select(starts_with("kp2_3430")) %>% psych::alpha(., na.rm = TRUE) %>% summary
...
cat('Cronbachs alpha(KR-20):')
ZA6838.data %>% select(starts_with("kp3_3430")) %>% psych::alpha(., na.rm = TRUE) %>% summary
...
cat('Cronbachs alpha(KR-20):')
ZA6838.data %>% select(starts_with("kp4_3430")) %>% psych::alpha(., na.rm = TRUE) %>% summary
...
cat('Cronbachs alpha(KR-20):')
ZA6838.data %>% select(starts_with("kp5_3430")) %>% psych::alpha(., na.rm = TRUE) %>% summary
...
cat('Cronbachs alpha(KR-20):')
ZA6838.data %>% select(starts_with("kp6_3430")) %>% psych::alpha(., na.rm = TRUE) %>% summary
...
cat('Cronbachs alpha(KR-20):')
ZA6838.data %>% select(starts_with("kp7_3430")) %>% psych::alpha(., na.rm = TRUE) %>% summary
...
DF$za6838.sel %<>% mutate(kp2_pwk1 = rowSums(across(kp2_3430r,kp2_3430m,kp2_3430l),na.rm = F),
                          kp2_pwk2 = rowSums(across(kp2_3430q,kp2_3430c,kp2_3430p),na.rm = F),
                          kp3_pwk1 = rowSums(across(kp3_3430a,kp3_3430t,kp3_3430u),na.rm = F),
                          kp3_pwk2 = rowSums(across(kp3_3430j,kp3_3430s,kp3_3430v),na.rm = F),
                          kp4_pwk1 = rowSums(across(kp4_3430r,kp4_3430m,kp4_3430l),na.rm = F),
                          kp4_pwk2 = rowSums(across(kp4_3430q,kp4_3430c,kp4_3430p),na.rm = F),
                          kp5_pwk1 = rowSums(across(kp5_3430a,kp5_3430t,kp5_3430u),na.rm = F),
                          kp5_pwk2 = rowSums(across(kp5_3430j,kp5_3430s,kp5_3430v),na.rm = F),
                          kp6_pwk1 = rowSums(across(kp6_3430r,kp6_3430m,kp6_3430l),na.rm = F),
                          kp6_pwk2 = rowSums(across(kp6_3430q,kp6_3430c,kp6_3430p),na.rm = F),
                          kp7_pwk1 = rowSums(across(kp7_3430a,kp7_3430t,kp7_3430u),na.rm = F),
                          kp7_pwk2 = rowSums(across(kp7_3430j,kp7_3430s,kp3_3430v),na.rm = F))
```
...
```{r}
# qsave(DF$za6838.sel, file = paste0(Sys.getenv("FAUBOX"),"/GLES/za6804/za6804_clpm.qs"))
```
