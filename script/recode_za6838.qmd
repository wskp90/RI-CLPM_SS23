...
pacman::p_load(sjlabelled,foreign,tidyverse,sjmisc,Hmisc,
...
```{r}
# tic()
DF$orgdat %>% select(contains("_1600")) %>% select(starts_with(c("kp17","kp18","kp19"))) %>%frq
...
DF$orgdat %>% select(contains("_4046")) %>% irr::icc()
