...
pacman::p_load(sjlabelled,foreign,
  psych,lm.beta, GPArotation,flextable,semTools,semPlot,lavaan,tidyverse,sjmisc,TAM,Hmisc,here,broom,questionr,codebook,DataExplorer,tidySEM,fs,usethis)
za6804 = read_spss(paste0(Sys.getenv("FAUBOX"),"/GLES/za6804/ZA6804_de_v7-0-0.sav"),drop.labels = T)
za6804 = za6804  %>%  select(lfdn, starts_with("kp1_3320"),starts_with("kp1_2180"),starts_with("kp1_1572"), starts_with("kp1_020"),
                             starts_with("kp1_040"), starts_with("kp1_5000"), starts_with("kp9_050"), starts_with("kp9_3103"),
                             starts_with("kp9_060"), starts_with("kp9_5010"), starts_with("kp9_160"), starts_with("kp9_2200"), 
                             starts_with("kp6_1555"), starts_with("kp3_1570"), starts_with("kp1a_1570"))
